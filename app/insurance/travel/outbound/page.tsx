...
<div className="w-full bg-white py-10 md:py-14">
  <div className="max-w-6xl mx-auto px-6 text-left">
    <h2 className="text-[28px] md:text-[38px] font-extrabold text-[#042B4A] leading-tight">
      Outbound Insurance in UAE by iNSURA.ae Powered by Pioneer.
    </h2>

    <p className="mt-4 text-[16px] md:text-[18px] text-gray-600 leading-relaxed">
      From sandy beaches to tall mountains, busy cities to quiet towns of 11,000,&nbsp;
      <span className="font-semibold text-[#042B4A]">iNSURA.ae</span> keeps you
      safe with Outbound Travel Insurance.
    </p>
  </div>
</div>
